...
export default function User(props)
{
    ...
    <div id='profilePage'>
        ...
        <div id="backgroundPic" style={{backgroundImage: `url(https://webere4870.blob.core.windows.net/react-app/bg${otherUser?._id})`}}>
            ...
            <div className='btnRow'>{user && <div onClick={()=>setPortal((prev)=>!prev)} className='userBubbles'><svg xmlns="http://www.w3.org/2000/svg" width="26" height="26" fill="white" class="bi bi-coin" viewBox="0 0 16 16">
...
</svg></div>}{user && <div onClick={(evt)=>setChatBoxOpen((prev)=>!prev)} className='userBubbles'>
